...
export function SignInCard() {
  ...
  return (
    <div className="relative w-full overflow-hidden rounded-3xl border border-white/10 bg-white/[0.03] p-8 backdrop-blur-2xl shadow-[0_0_80px_rgba(139,92,246,0.15)]">
