const courses = [
    ...
    description:
        "A beginner-friendly program designed to build digital confidence, computer literacy, internet skills, productivity expertise, and foundational knowledge of design, technology, and AI tools.",
    ...
    projectsList: [
        ...
        description:
            "Create a modern job-ready resume using digital tools."
        },
        {
        title: "Business Presentation",
        description:
            "Build and present a professional slide deck."
        },
        {
        title: "Canva Design Portfolio",
        description:
            "Design flyers, social posts and promotional graphics."
        },
        {
        title: "AI Productivity Workflow",
        description:
            "Create a workflow using ChatGPT and productivity tools."
        }
    ],
    ...
    faqs: [
        ...
        answer:
            "No. This program is designed specifically for complete beginners."
        },
        {
        question: "Will I receive a certificate?",
        answer:
            "Yes. Students receive a certificate upon successful completion."
        },
        {
        question: "What happens after this course?",
        answer:
            "Graduates can progress into Frontend Engineering, Backend Engineering, Data Intelligence, or other advanced Korva Tech Hub programs."
        }
    ],
    courseOutline: "5",
    ...
    description:
        "Learn how to design and build modern, responsive, and production-ready web applications using UI/UX principles, frontend technologies, and AI-powered development workflows.",
    ...
    // COURSE OVERVIEW
    overview:
        "Master the complete frontend development workflow from design to deployment. Learn how to create stunning interfaces, build reusable components, optimize performance, and leverage AI tools to accelerate development and improve user experience.",
    ...
    projectsList: [
        ...
        description:
            "Build a professional developer portfolio using HTML, CSS and JavaScript."
        },

        {
        title: "Modern Landing Page",
        description:
            "Design and develop a conversion-focused responsive landing page."
        },

        {
        title: "UI/UX Case Study",
        description:
            "Research, design and prototype a complete digital product in Figma."
        },

        {
        title: "React Dashboard",
        description:
            "Build an interactive dashboard using React and reusable components."
        },

        {
        title: "Full Next.js Application",
        description:
            "Develop and deploy a production-ready Next.js project."
        }
    ],
    ...
    capstoneProject: {
        ...
        description:
        "Design and build a complete SaaS platform frontend including authentication, dashboard, settings pages, responsive layouts and API integration."
    },
    ...
    faqs: [
        ...
        answer:
            "No. The course starts from the fundamentals and gradually progresses to advanced frontend concepts."
        },

        {
        question: "Will I learn both design and coding?",
        answer:
            "Yes. This program combines UI/UX design principles with frontend development skills."
        },

        {
        question: "Will I build real projects?",
        answer:
            "Absolutely. Students complete multiple projects and a capstone application for their portfolio."
        },

        {
        question: "Will I receive a certificate?",
        answer:
            "Yes. Students who complete the program successfully receive a certificate."
        }
    ],
    courseOutline:
    "6",
    ...
    description:
      "Learn backend development, APIs, databases, authentication, cloud deployment and AI-assisted engineering workflows.",
    ...
    // OVERVIEW TAB
    overview:
      "Master backend architecture and scalable systems. Build APIs, authentication systems, databases and cloud deployments using modern development workflows enhanced by AI tools.",
    ...
    faqs: [
      {
        question: "Do I need coding experience?",
        answer:
          "No. We start from the fundamentals.",
      },
      {
        question: "Will I receive a certificate?",
        answer:
    ...
    careerPath:
    "Backend Developer, API Developer, Node.js Engineer, Cloud Engineer, Software Engineer",

    portfolioProjects: 8,

    capstoneProject:
    "Design and deploy a scalable backend platform with authentication, payments, cloud hosting, monitoring, and AI-powered features.",
  ...
  },
  {
    ...
    description:
    "Master frontend, backend, databases, authentication, payments, DevOps, cloud deployment, AI-assisted development, and software architecture by building real-world production applications.",
    ...
    overview:
    "Become a complete software engineer capable of designing, building, deploying, and maintaining modern web applications. Learn frontend development, backend engineering, databases, cloud deployment, DevOps, payments, authentication, SaaS architecture, and AI-powered engineering workflows.",
    ...
    description:
    "Design, build and deploy a complete SaaS platform with authentication, subscriptions, payments, dashboards, notifications, analytics, admin management and AI-powered features."
    },
    courseOutline:
    "14",
    technologies: [
    ...
    jobReadiness:
    "Prepare for Fullstack Developer, Software Engineer, Product Engineer and Junior-to-Mid Level Engineering roles.",

    salaryOutlook:
    "Entry-Level Fullstack Developers can work remotely, freelance, join startups, agencies, software companies or build their own products.",

    careerPath:
    "Fullstack Developer, Software Engineer, Product Engineer, SaaS Developer, Technical Founder",
    ...
    description:
        "Master modern data analysis, business intelligence, SQL, Python, dashboards, reporting, and AI-powered analytics workflows to transform raw data into actionable insights.",
    ...
    overview:
        "Learn how organizations use data to make strategic decisions. This program teaches data collection, cleaning, transformation, analysis, visualization, reporting, business intelligence, and AI-enhanced analytics workflows through real-world projects and case studies.",
    ...
    projectsList: [
        ...
        description:
            "Build an executive dashboard showing revenue, growth, and sales KPIs."
        },

        {
        title: "Customer Insights Analysis",
        description:
            "Analyze customer behavior and identify business opportunities."
        },

        {
        title: "Marketing Campaign Analytics",
        description:
            "Evaluate campaign performance and optimize marketing strategies."
        },
        ...
        description:
            "Use AI tools to automate analysis and generate business recommendations."
        }
    ],
    ...
    capstoneProject: {
        ...
        description:
        "Design and deliver a complete business intelligence solution that integrates SQL, Python, Power BI, and AI-powered insights to help executives make data-driven decisions."
    },
    ...
    faqs: [
        ...
        answer:
            "No advanced mathematics is required. The program focuses on practical analytics and business intelligence."
        },

        {
        question: "Will I learn SQL and Python?",
        answer:
            "Yes. SQL and Python are core components of the curriculum."
        },

        {
        question: "Will I build real dashboards?",
        answer:
            "Absolutely. Students build multiple dashboards and analytics projects using real-world datasets."
        },

        {
        question: "Can this help me get a data analyst role?",
        answer:
            "Yes. The curriculum is designed around the skills commonly required for entry-level data analyst and BI analyst positions."
        }
    ],
    courseOutline:
    "11",
    ...
    careerPath:
    "Data Analyst, Business Intelligence Analyst, Reporting Analyst, Data Associate, Business Analyst, Analytics Consultant",
...
},
{
  level: 8,
  code: "hia",
  title: "Professional Certificate in Health Informatics and Data Analytics",
  ...
  overview:
    "This 6-month Professional Certificate program supports your transition from nursing and healthcare into Health Informatics and Data Analytics. No prior technical experience is required. You will learn to work with healthcare data using Excel, SQL and Power BI, understand health information systems and standards, and build a portfolio suitable for junior health data analyst roles in the UK and globally.",
  outcomes: [
    "Perform end-to-end analysis using Excel, SQL and Power BI",
    "Design and query a simple healthcare database",
    "Create calculated measures and professional dashboards",
    "Understand EHR workflows and health data standards",
    "Assess data quality and document improvement processes",
    "Communicate findings to clinical and non-clinical audiences",
    "Present a portfolio suitable for junior health data analyst roles",
  ],
  curriculum: [
    {
      title: "Month 1: Digital and Health Informatics Foundations",
      duration: "4 Weeks",
      lessons: [
        "Digital skills assessment and computer fundamentals",
        "Introduction to health, clinical, nursing and public-health informatics",
        "Healthcare organisations, workflows and the patient information journey",
        "Types and sources of healthcare data",
        "Roles in health informatics and data analytics",
        "UK GDPR, Data Protection Act 2018 and Caldicott principles",
        "Practical: Map how information moves from patient registration through discharge",
      ],
    },
    {
      title: "Month 2: Excel and Healthcare Data Quality",
      duration: "4 Weeks",
      lessons: [
        "Excel from beginner to intermediate level",
        "Tables, formulas, conditional logic and lookup functions",
        "Dates, text manipulation and data validation",
        "Cleaning missing, duplicated and inconsistent records",
        "PivotTables, charts and exploratory analysis",
        "Healthcare indicators and descriptive statistics",
        "Data-quality dimensions and data dictionaries",
        "Portfolio Project 1: Analyse clinic attendance or maternal-health service data",
      ],
    },
    {
      title: "Month 3: SQL and Healthcare Databases",
      duration: "4 Weeks",
      lessons: [
        "Relational database concepts, tables, keys and relationships",
        "SELECT, WHERE, ORDER BY, GROUP BY and aggregate functions",
        "JOIN operations, CASE statements and subqueries",
        "Handling dates, NULL values and duplicates",
        "Basic database design and entity-relationship thinking",
        "Querying patient, encounter, diagnosis and facility tables",
        "Data security and appropriate access concepts",
        "Practical: Build and query a small synthetic hospital database",
      ],
    },
    {
      title: "Month 4: Power BI and Data Storytelling",
      duration: "4 Weeks",
      lessons: [
        "Importing data and transforming it with Power Query",
        "Data models and table relationships",
        "Measures, calculated columns and introductory DAX",
        "KPI cards, trends, drill-downs, filters and slicers",
        "Dashboard layout, accessibility and storytelling",
        "Publishing and sharing concepts",
        "Communicating insights to clinicians and managers",
        "Portfolio Project 2: Create an interactive hospital-performance dashboard",
      ],
    },
    {
      title: "Month 5: Health Information Systems and Standards",
      duration: "4 Weeks",
      lessons: [
        "NHS structure — primary, secondary and community-care information flows",
        "EPR/EHR structure, benefits and implementation challenges",
        "Laboratory, pharmacy and radiology information systems",
        "Public-health and NHS reporting concepts",
        "Interoperability and health data standards",
        "ICD-10, SNOMED CT, HL7 and FHIR overview",
        "NHS Number and patient-matching concepts",
        "Data governance, audit trails and cybersecurity awareness",
        "Practical: Evaluate a fictional hospital EHR transition",
      ],
    },
    {
      title: "Month 6: Applied Project and Career Preparation",
      duration: "4 Weeks",
      lessons: [
        "Selecting an appropriate problem and defining analysis questions",
        "End-to-end data cleaning, analysis and visualisation",
        "Writing an analytical report and executive summary",
        "Portfolio, CV, LinkedIn and interview preparation",
        "Practice technical and scenario-based interviews",
        "Introduction to GitHub for portfolio",
        "Capstone Project: Choose from maternal health, hospital waiting-time analysis, disease-surveillance dashboard or healthcare data-quality audit",
        "Final submission: cleaned dataset, SQL queries, Power BI dashboard, written report and presentation",
      ],
    },
  ],
  projectsList: [
    {
      title: "Healthcare Data Quality Analysis",
      description: "Analyse clinic attendance or maternal-health service data in Excel and present findings.",
    },
    {
      title: "Hospital Performance Dashboard",
      description: "Create an interactive Power BI dashboard using hospital performance or public-health data.",
    },
    {
      title: "Capstone: Applied Health Informatics Project",
      description: "End-to-end project combining Excel, SQL and Power BI with a written report and presentation.",
    },
  ],
  instructors: [
    {
  ...
  requirements: [
    "Healthcare or nursing background helpful but not required",
    "Laptop with internet connection",
    "Microsoft Excel and Power BI Desktop (Windows required for Power BI)",
    "Willingness to learn and practice consistently",
  ],
  targetAudience: [
    "Nurses transitioning into health informatics",
    "Healthcare professionals entering data roles",
    "NHS staff seeking data and informatics skills",
    "Anyone pursuing health data analyst roles",
  ],
  careerPaths: [
  ...
  includes: [
    "Live Classes (2 sessions per week)",
    "2 Hours 30 Minutes Per Session",
    "Experienced Health Informatics Instructor",
  ...
  faqs: [
    {
      ...
      answer: "No. The program starts from the basics and builds up gradually.",
    },
    {
      question: "Will I receive a certificate?",
      answer: "Yes. A Professional Certificate is awarded upon successful completion.",
    },
  ],
  courseOutline: "6",
  courseDuration: "6 Months",
  classSchedule: "2 Days / Week",
  classFormat: "2 Hours 30 Minutes Per Session",
  studyMaterials: true,
  internship: false,
  examIncluded: true,
  communityAccess: true,
