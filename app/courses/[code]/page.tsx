          ...
          <div className="grid gap-10 lg:grid-cols-[1fr_380px]">
            ...
            <div>
              <div className="mb-8">
                ...
                <p className="mt-4 text-lg text-neutral-400">{course.tagline}</p>
              </div>
              ...
              <div className="rounded-3xl border border-neutral-800 bg-neutral-900/40 p-8">
                ...
                <p className="mt-4 text-neutral-300">{course.overview}</p>
              </div>

              {/* SIDEBAR shown here on mobile only */}
              ...
              <div className="mt-10">
                ...
                {course.projectsList && (
                  <div className="mt-14">
                    <h2 className="mb-6 text-2xl font-bold">Projects You'll Build</h2>
                ...
                <h2 className="my-10 text-2xl font-bold">Expected Learning Outcomes</h2>
                <div className="grid gap-4 md:grid-cols-2">
                  {course.outcomes.slice(0, 6).map((item) => (
                    <div key={item} className="rounded-xl border border-neutral-800 p-4">
                      ✓ {item}
                    </div>
                  ))}
                </div>
              ...
              {course.careerPath && (
                <div className="mt-14">
                  <h2 className="mb-6 text-2xl font-bold">Career Opportunities</h2>
                  <div className="rounded-3xl border border-violet-500/20 bg-violet-500/5 p-8">
                    <p className="text-lg leading-relaxed text-white/80">{course.careerPath}</p>
                  </div>
                </div>
              )}
            </div>
